...
In contrast to the common notion, we observed that the conversion of reads to molecules using the UMIs was impacted by both biological and technical variation, indicating that UMI counts cannot assumed to be an unbiased estimator of gene expression levels.
