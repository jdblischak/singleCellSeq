...
Four single cells from the lymphoblastoid cell line of NA19239 were each sequenced separately on one lane of a Hi-seq 2500.
This resulted in sequencing depths greater than 80 million per single cell.
(A-B) The number of (A) endogenous genes or (B) ERCC spike-in controls detected with at least 1 molecule.
(C-D) The total number of molecules mapping to (C) endogenous genes or (D) ERCC spike-in controls per single cell as a function of sequencing depth.
(E-F) The total number of reads mapping to (C) endogenous genes or (D) ERCC spike-in controls per single cell as a function of sequencing depth.
