...
The dash lines indicate the cutoffs based on the 95 percentile of the samples with no cells.](figure/Figure06.jpeg)
...
Each point represents a gene, and red lines indicate the predicted values using locally weighted scatterplot smooth (LOESS).](figure/Figure09.jpeg)
...
Blue line indicates the fitted relationship between -log10 *P*-values and average log2 gene expression levels of cells that were detected as expressed, using locally weighted scatterplot smooth (LOESS).
(C) Median of Absolute Deviation (MAD) of genes versus average gene expression levels.
Green line indicates the fitted relationship between the MAD values and average log2 gene expression levels of cells that were detected as expressed, also using LOESS.](figure/Figure10.jpeg)
...
The pooled samples were assigned across the four 8-lane flowcells.](figure/Figure16.jpeg)

### Table `r table_noisygene`. Genes associated with inter-individual differences in regulatory noise.
List of genes that we classified the estimates of regulatory noise as significantly different across individuals (empirical permutation *P* < 10^-4^). There are total 560 genes.
