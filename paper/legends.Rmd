...
(B) Summary of the cutoffs used to filter out data from low quality cells that might be raptured or dead (See Figure `r fig_supp_qc` for details).
...
The three colors represent the three individuals (NA19098 in red, NA19101 in green, and NA19239 in blue), and the numbers indicate the cells observed in each capture site on C1 plate. 
...
Four single cells from the lymphoblastiod cell line of NA10239 were each sequenced separately on their own lane of a Hi-seq 2000.
