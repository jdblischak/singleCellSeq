...
The endogenous genes and the ERCC spike-ins are shown in (A) and (B), respectively.
...
Each point represents the mean +/- SEM of the raw total gene molecule-counts per sample.
