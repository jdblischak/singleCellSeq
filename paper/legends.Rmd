...
The gene-specific dropout rate (the proportion of cells in which the gene is undetected) and its relationship with log~10~ mean expression, with log~10~ variance of expression, and with the adjusted log10-CV when the samples in which the gene was not detected as expressed (dropout) are included (A-C) and are excluded (D-E).
