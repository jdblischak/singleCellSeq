...
Box plots of the proportion of per-gene cell-to-cell variance that is due to individual sample of origin, different C1 replicates, and other single cell sample differences.
