...
Green line indicates the fitted relationship between the MAD values and average log2 gene expression levels of cells that were detected as expressed, also using LOESS.
