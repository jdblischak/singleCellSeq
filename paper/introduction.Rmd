...
Single-cell technologies coupled with RNA sequencing enable the characterization of steady state gene expression levels from a large number of single cells with high reproducibility [@Macaulay2014; @Saliba2014]. 
...
These (and other sources of error) may not be unique to single cell technologies, but in the context of studies where each sample (single cell) is processed as a single batch, these technical considerations make the analysis of biological variability across single cells particularly challenging.

The use of unique molecule identifiers (UMIs) was proposed to address challenges that are related to the efficiency and uniformity with which mRNA molecules are amplified and sequenced in single cells [@Kivioja2011; @Fu2011; @Casbon2011; @Shiroguchi2012].
