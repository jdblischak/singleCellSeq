...
Ultimately, these parameters should be determined based on the goal of the study. In our case, we focused on recapitulating the gene expression levels observed in bulk sequencing experiments and the cell-to-cell variance in gene expression levels across single cells.
