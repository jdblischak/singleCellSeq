...
However, to fully capture the batch effect across C1 plates and to retrieve the maximum amount of biological information, we recommend a balanced study design consisting of multiple individuals within a C1 plate and multiple C1 replicates (for example, Sup. figure 9). 
In such a scenario, single cells can be assigned to biological samples based on their genotypes, which can be characterized based on the RNA sequencing (see Sup. figure 9). 
