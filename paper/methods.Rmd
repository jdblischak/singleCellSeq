...
In an initial analysis investigating the percentage of reads mapping to the ERCC spike-in controls, we observed that replicate 2 of individual NA19098 was a clear outlier (Sup Figure. `r fig_supp_qc`A and `r fig_supp_qc`B).
...
We also removed these misidentified wells using linear discriminant analysis (TODO: expand explanation).
