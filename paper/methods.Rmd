...
For each single cell, we fit a Poisson generalized linear model (GLM) between the expected ERCC molecule counts and the observed ERCC molecule counts.
Next we used the slope and intercept of the Poisson GLM regression line to transform the log~2~ cpm for the genes in that cell.
