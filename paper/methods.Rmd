...
4. Standardize each cell line's adjusted log10 CVs by substracting the respective mean and standard deviation across genes. The final adjusted measurements are referred to as *SSCV* (Standardized Squared Coefficients of Variation).
