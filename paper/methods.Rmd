...
### Tests for the significance of individual effect and batch effect


For the correaltion between sample concentration and total endogenous gene molecule-counts, we excluded individual 19098, because we only obtained concentration measurements from one C1 replicate. 
We observed that the relationship between total single cell molecule-counts and concentration is significantly different across individuals (19101: r = 0.28, 19239: r = 0.53; likelihood ratio test, p < 0.001), as well as across C1 collection replicates from the same individual (19101: -0.06, .36, .51, 19239: -.04, .75, .78, F-test, p < 0.01). 

### Variance component analysis for gene expression profile
...
We fit a linear mixed model for each gene $g$ that includes a fixed effect of individual cell lines and a random effect for within-batch variation attributed to cell-to-cell correlation in each C1 plate: 
