...
3.  The Pearson correlation of the cell-to-cell gene expression level variance estimates from the subsampled single cells compared to the variance estimates using the full single cell data set.
