...
To investigate the effect of the unobserved, or the dropout, measurements, we separately measured the gene expression noise with or without the cells where a given gene was not detected/expressed [@Shalek2013]. 
While including all quality single cells, we found that 887 genes were ranked among the top 1,000 highly expressed genes in all three individuals, whereas 103 genes were ranked among the top 1,000 noisy genes (Figure. 5A and 5B), indicating the presence of differential cell-to-cell variation in gene expression across individuals.
Similar results were found after excluding the undetected cells on a per gene basis, where the three individuals shared 887 highly expressed genes and 95 highly noisy genes.

We also looked at the proportion of undetected cells (the dropout rate) of each gene and its association with gene abundance and expression noise.
We found that the proportion of undetected cells varied between genes, which has the median ranged between 21 to 30 percent in the three individuals.
Significant individual difference in proportion of undetected genes were found in more than 10 percent of the genes (1,958 genes).
Expectedly, gene abundance and variance of the expressed cells were associated with the proportion of undetected cells (Sup). 
However, importantly, the variability measure CV was not associated with proportion of undetected cells (Spearman's correlation = .04) across the three individuals (Figure. 5C and 5D), supporting the idea that CV is not confounded with the dynamic range of gene abundance. 
...
We found two highly expressed pluripotency genes *DNMT3B* and *NR6A1* among the differential noisy genes, both of which were detected in all single cells (Sup. Figure. 10).
However, majority of the pluripotency genes were not detected in all the cells and exhibited no differential noisy pattern, including key pluripotency genes *Nanog* and *ZFP42* (Sup. Figure. 10), indicating that the pluripotent state was tightly regulated.
Notably, despite the association between gene abundance and proportion of undetected genes, we found no associations between the individual differences, and similarly for individual differences in expression noise and proportion of undetected genes (Figure. 6). 
