...
Before the processing of the individual cell samples, we performed visual inspection on the C1 microfluidic plates. 
...
The variation in gene expression levels across single cells is also estimated well with roughly 75 single cells (r > 0.95, Figure `r fig_main_subsample`C).
