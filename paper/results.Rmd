...
Moreover, the difference in read-to-molecule conversion efficiency across the three individuals was significant not only for endogenous genes (LRT; *p* < 0.01) but also in the ERCC spike-ins (LRT; *p* < 0.01, Figure. 3D).
...
We found significant differences (test; P < XX) in gene-specific dropout rates between individuals in more than 10% (1958 of `r format(sum(grepl("ENSG", rownames(molecules_filter))), big.mark = ",")`) of expressed endogenous genes.
