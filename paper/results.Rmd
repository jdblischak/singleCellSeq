...
While we do not expect this step to account for the batch effect (as discussed above), we reasoned that the spike-ins allow us to effectively standardize molecule counts across individuals (Figure `r fig_main_normalization`C).
