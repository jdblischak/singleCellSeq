...
In practice, however, total ERCC molecule-counts were significantly different across C1 batches (F-test; *P* < 0.001), yet not across individuals (LRT; *P* = 0.08;  Figure `r fig_main_batch`A).
In addition, while we observed a positive relationship between total ERCC molecule-counts and total endogenous molecule-counts per sample, this correlation pattern differed across C1 batches as well (F-test; *P* < 0.001; Figure `r fig_main_batch`B).
