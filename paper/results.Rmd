...
In the absence of technical noise, the total ERCC molecule-counts per sample is the same, not affected by the total endogenous gene molecule-counts or the percentage of ERCC molecules among all molecules.
However, we observed a clear differences across the three individuals (Sup Figure. 7), yet not across C1 replicates of the same individuls, suggesting that some unidentified factors inherent from the individual difference to the distribution of gene expression in the single cells is consistently affecting the molecule-counts.
