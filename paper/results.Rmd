...
In the absence of technical noise, the total ERCC molecule-counts per sample is the same, not affected by the total endogenous gene molecule-counts or the percentage of ERCC molecules among all molecules (Sup. Figure. 4C and 4D, repectively).
