...
#### Total molecule counts and cell cycle phase
...
To investigate the relationship between total molecule counts and cellular mRNA contents from the same C1 collection, we first classified the cell cycle phase of each cell based on gene expression 
...
#### ERCC spike-ins and cellular mRNA content
