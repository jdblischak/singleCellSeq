...
When looking at the intersection of the top 1,000 individual-specific noisy genes according to their DM values, we found 120 common noisy genes between the three individuals (Figure. 6A), which was smaller than the 891 common highly expressed genes between individuals (Figure. 6B), indicating the presence of differential cell-to-cell variation in gene expression across individuals.  
...
We did not find any key pluripotency genes to have differential noise measurements across individuals (Sup. Figure. 10), including Nanog and ZFP4 (Figure. 6C and D, respectively), indicating that the pluripotent state was tightly regulated.
More importantly, we observed a number of individual cell-to-cell variation patterns of genes with significant MAD values under the scenarios of differential number of subpopulations, differential proportion of subpopulations, and differential spread or variance (Figure. 6E-F). 
