...
[update results after incorporating ERCC Poisson normalization]

To directly remove unwanted techncial variation between C1 plates, we modeled between well correlation in gene expression within C1 plates. We assumed that C1 plates share similar techncial variation due to gene expression similarity between cells on the same plate. The results of PCA on the corrected data showed that the samples from different C1 replicates of the same individual largely overlapped, indicating that we have successfully removed a large proportion of sample variation due to C1 replicate differences. [OEF finder results?]


### Cell-to-cell variability of gene expression
[update results after incorporationg ERCC Poisson normalization]

- we examined endogeneous transcriptional variability as a function of RNA abundance using molecule count data after ERCC transformation and batch correction; we computed coefficients of variation (CV) of transcriptional gene expression for each individual iPSC cell line under the overdispersed Poisson framework; cell-to-cell transcriptional variability is similar across the three iPSC cell lines (1.6 times of Poisson distribution). [suppl.]

- however, we found many more genes with high transcriptional variability in NA19101 (435 genes) compared to NA19239 (114 genes) and NA19098 (36 genes) [mean-cv plots, venn diagram]
- and that the high variability genes are more likely to be shared than to be unique to individual iPSC cell lines (Percent high variability genes shared: NA19098 67%; NA19101 55%; and NA19239 85%)
- Of the 11 genes show a heterogenoeus gene expression patterns in all three cell lines, only 4 genes are related to cell cycle; gene annotation

- because coefficients of variation are confounded with mean gene expression, 
