...
Furthermore, the transcriptional noise variation exhibited a few interesting patterns across individuals, such as proportion and expression variability of the expressed cells, and also the proportion of drop-outs (non-expressed cells) (Figure. 6).
For instance, *TFPI* and *Nanog* in individual 19101 exhibited a higher number of expressed cells and also a wider range of expression among the expressed cells compared to the other two individuals, yet the difference of adjusted CV was not significant across three individuals.
