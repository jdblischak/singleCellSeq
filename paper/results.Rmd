...
(C) Pearson correlation of cell-to-cell gene expression variance estimates from subsets of single cells compared to the full single cell data set.](figure/fig-subsample-uncompressed.tiff)
...
Data from different C1 replicates is plotted in different shapes.](figure/fig-data-transformation-uncompressed.tiff)
...
(E and F) Similarly, Venn diagrams showing the overlaps of top 1000 genes across individuals based on mean expression level in (E) and based on adjusted CV values in (F), across all cells.](figure/Figure05.tiff)
