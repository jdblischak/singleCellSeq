...
We didn't observe any obvious technical effects due to sequencing lane or flow cell that confounded the interindividual and interreplicate comparisons (data not shown).
...
We analyzed cell-to-cell expression variation in iPSC cells after removing unwanted technical variability from scRNA-seq data as described above. Endogenous transcriptional variability in iPSC cell populations was examined as a function of RNA abundance across C1 replicates. Coefficient of variation (CV) of molecule counts among endogeneous genes and ERCC spike-in genes suggests similar expression variability patterns that track the expected Poisson distribution (Sup Figure. 8A). Our findings are consistent with previous studies of mouse ESCs and Mus musculus cells [@Islam2014; @Brennecke2013]. 


#### Transcriptional noise

Transcriptional variability across both expressed and non-expressed cells in scRNA-seq data quantifies a measure of expression noise in the cell population. Because gene expression variability in sequencing data is correlated with mean gene RNA abundance level, we adjusted our variabilty measure (CV) by mean gene abundance level (see the Methods section, Sup Figure. 8B). Similar noise measure was used in Kolodziejczyk et a., [@Kolodziejczyk2015] to investigate transcriptional noise in mouse ESCs. We found that 120 genes were ranked among top 1,000 noisy genes in all three iPSCs (Figure. 5A), while 891 genes were ranked among top 1,000 highly expressed genes in all three cell lines (Figure. 5B), indicating the presence of differential cell-to-cell variation in gene expression between individuals.  

We identified differential noisy genes between individuals, using the median of absolute deviation (MAD) to quantify the degree of dissimilarity between individual noise measures. Our permutation-based test indicated that 263 genes were found to have statistically significant differences in transcriptional noise between individuals, at an alpha-level of $10^{-5}$ (Sup Table. X of gene list, Sup. Figure. 9). Of these 263 genes, 94 were classified as a top noisy genes in at least one iPSC. Enrichment analysis suggested that these 94 genes were enriched for genes involved in protein translation, protein disassembly, and various biosynthetic processes (Sup Table. X). We did not find any key pluripotency genes to have differential noise measurements across individuals (Sup. Figure. 10), including Nanog and ZFP42 (Figure. 5C and D, respectively), indicating that the pluripotent state was tightly regulated.

Transcriptional noise variation exhibited a few interesting patterns between individuals, such as proportion and expression variability of the expressed cells, and proportion of drop-outs (non-expressed cells) (Figure. 5E-F). For instance, NLRP2 in individual 19101 exhibited smaller number of expressed cells compared to the other two individuals, and a more narrow range of expression among the expressed cells compared to individual 19238 . On the other hand, FAT3 exhibited a similar range of variation in the expressed cells between the three individuals, but the number of express cells was different between the individauls. 


#### Transcriptional variability of the expressed cells

We also investigated transcriptional variability of the expressed cells - cells that were quantified by one or more molecule counts in each gene. The same variability measure of transcriptional noise was computed to quantify expression variation of the expressed cells. We found that coefficient of variation in genes with less than 50% of drop-outs decreases as a function of gene abundance; while, CV in genes with drop-out rates more than 50% were found to increase as a function of gene abundance. Interestingly, when all cells were included in the anaysis, CV decreases as a function of abudance across drop-out rates. Our results suggested that transcriptional variability of the expressed cells depends on the drop-out rate as well as mean gene abundance.

Similar to transcriptional noise, small number of 89 genes were consistently ranked among the top 1,000 most variable genes between the three individuals, indicating a similar degree of differential variability between the expressed cells and the set of cells that include drop-outs. However, we found no correlation between the CVs of these two sets of cells (supp. figure). Based on our dissimilarity measure of expression variability (MAD), only 25% of the top 100 differentially variable genes in the expressed cells were among the top 100 differential noisy genes. Enrichment analysis of the 75 differentially variable genes that were not noisy indicated that these genes were enriched for genes involved in decidualizaiton and maternal placenta development (MEN1, CITED2, BSG). On the other hand, the 25 genes that were found to be different in both expression noise and expression variabilty of the expressed cells were enriched for regulation of biosynthetic process and cellular metabolic process. (Maybe include aa figure that shows the individual density distriubtions for some of these genes..)
