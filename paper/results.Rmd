...
To estimate the mRNA capture efficiency, we first calcutated the input molecule numbers of ERCC spike-in RNA transcripts and then compared the imput quantities with the observed quantities. 
