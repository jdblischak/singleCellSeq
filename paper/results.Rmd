...
Indeed, we found a general correlation between total molecule-counts in single cells and the measured sample concentration (Sup. Figure. ).
...
However, we observed a clear differences across the three individuals (Sup Figure. 7), yet not across C1 replicates of the same individuals, suggesting that some unidentified factors inherent from the individual difference to the distribution of gene expression in the single cells is consistently affecting the molecule-counts.
