...
(C) Pearson correlation of cell-to-cell gene expression level variance estimates from subsets of single cells compared to the full single cell data set.](figure/Figure2.jpg)
...
The differences across C1 replicates per individual of endogenous genes and ERCC spike-ins were also evaluated (both *P* < 0.01).](figure/Figure3.jpg)
...
Data from different C1 replicates is plotted in different shapes.](figure/Figure4.jpg)
...
(E and F) Similarly, Venn diagrams showing the overlaps of top 1000 genes across individuals based on mean expression level in (E) and based on adjusted CV values in (F), across all cells.](figure/Figure5.jpg)
