...
We examined endogeneous transcriptional variability as a function of RNA abundance across C1 replicates of individual cell lines.
Coefficient of variation of molecule counts was computed after collision correction and transformations.
We found similar variation pattern of endogeneous genes and ERCC spike-in genes, and both closely track the expected Poisson distribution as a function of RNA abundance (Supplemental figure XX1). 
...
We refer to this individual-specific noise measure as distance-to-the-median (DM, see the Methods section, supplemental figure XX2). Large DM values correspond to large individual-specific CVs compared to global CVs that are at similar RNA abundance levels.
Figure 6b shows the intersection of the top 1,000 individual-specific noisy genes. We found 120 common noisy genes between the individuals (Figure 6b, Supplemental Figure), which is smaller than the 891 common highly expressed genes between individuals (Figure 6a).
...
263 genes were found to have statistically significant MAD values at an alpha-level of $10^{-5}$ (supplemental table X of gene list, supplemental figure XX3).
...
Enrichment analysis suggests that these 263 genes were enriched for housekeeping genes and encoding ribosomal proteins (supplemental table). 
