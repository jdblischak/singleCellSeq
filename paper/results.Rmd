...
In the following, we used the standardized, normalized, batch-corrected molecule count gene expression data to estimate regulatory noise (Figure `r fig_main_normalization`D).
...
Based on permutations (Figure `r fig_supp_permutation`), we classified the estimates of regulatory noise of 560 genes as significantly different across individuals (empirical *P* < .0001, Figure `r fig_supp_noisygene` for examples; Table `r table_noisygene` for gene list).
