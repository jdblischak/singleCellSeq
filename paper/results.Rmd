...
We first investigated the biological gene expression variability, or gene expression noise, across single cells of each individual, and then we further identified genes that present differential expression noise across the three individuals.
...
While including both expressed and non-expressed cells of the given gene for measuring of gene expression noise in each individual, we found that 120 genes were ranked among top 1,000 noisy genes (Figure. 5A), while 891 genes were ranked among top 1,000 highly expressed genes (Figure. 5B), indicating the presence of differential cell-to-cell variation in gene expression across individuals.  
...
We found that CV of genes with less than 50% drop-outs decreases as a function of gene abundance, while CV of genes with drop-out rates more than 50% were found to increase as a function of gene abundance (Sup. Figure X). 
