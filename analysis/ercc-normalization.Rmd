...
```{r bulk-ruv-invar-k5}
bulk_ruv_object_invar_k5 <- RUVg(x = as.matrix(reads_bulk),
                                cIdx = c(ercc_rows_bulk, bulk_least_variant_rows),
                                k = 5)
bulk_ruv_invar_k5 <- bulk_ruv_object_invar_k5$normalizedCounts
bulk_ruv_cpm_invar_k5 <- cpm(bulk_ruv_invar_k5, log = TRUE,
                            lib.size = calcNormFactors(bulk_ruv_invar_k5) * 
                                       colSums(bulk_ruv_invar_k5))
```
...
```{r single-ruv-invar-k5}
single_ruv_object_invar_k5 <- RUVg(x = as.matrix(molecules_single),
                                cIdx = c(ercc_rows_single, single_least_variant_rows),
                                k = 5)
single_ruv_invar_k5 <- single_ruv_object_invar_k5$normalizedCounts
single_ruv_cpm_invar_k5 <- cpm(single_ruv_invar_k5, log = TRUE,
                            lib.size = calcNormFactors(single_ruv_invar_k5) * 
                                       colSums(single_ruv_invar_k5))
```
...
### bulk log2 reads per million - k = 5

```{r pca-bulk-ruv-invar-k5}
pca_bulk_ruv_invar_k5 <- run_pca(bulk_ruv_cpm_invar_k5[gene_rows_bulk, ])
plot_pca(pca_bulk_ruv_invar_k5$PCs, explained = pca_bulk_ruv_invar_k5$explained,
         metadata = anno_bulk, color = "individual",
         shape = "batch", factors = c("individual", "batch"))
```
...
### single log2 molecules per million - k = 5

```{r pca-single-ruv-invar-k5}
pca_single_ruv_invar_k5 <- run_pca(single_ruv_cpm_invar_k5[gene_rows_single, ])
plot_pca(pca_single_ruv_invar_k5$PCs, explained = pca_single_ruv_invar_k5$explained,
         metadata = anno_single, color = "individual",
         shape = "batch", factors = c("individual", "batch"))
```
