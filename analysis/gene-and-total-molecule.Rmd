...
## ggplot
v_19098 <- as.vector(molecules_single_cpm_19098)
...
ggplot(anno_single, aes(x = as.factor(individual), y = total_molecule, fill = as.factor(batch))) + geom_violin(alpha = 0.5) + geom_boxplot(alpha = 0.01, width = 0.1, position = position_dodge(width = 0.9))

ggplot(anno_single, aes(x = as.factor(individual), y = number_genes, fill = as.factor(batch))) + geom_violin(alpha = 0.5) + geom_boxplot(alpha = 0.1, width = 0.1, position = position_dodge(width = 0.9))
```
