...
molecules_single_19098 <- as.matrix(log(molecules_single[,grep("19098", colnames(molecules_single))]+1))

## 19101 (total 197 cells)
molecules_single_cpm_19101 <- molecules_single_cpm[,grep("19101", colnames(molecules_single_cpm))]
molecules_single_19101 <- as.matrix(log(molecules_single[,grep("19101", colnames(molecules_single))]+1))

## 19239 (total 197 cells)
molecules_single_cpm_19239 <- molecules_single_cpm[,grep("19239", colnames(molecules_single_cpm))]
molecules_single_19239 <- as.matrix(log(molecules_single[,grep("19239", colnames(molecules_single))]+1))
...
plot_multi_dens(list(molecules_single_19098, molecules_single_19101, molecules_single_19239))
legend(12,1.8, c("19098","19101", "19239"), lwd=c(2.5,2.5),col=c("black", "red", "green"))
