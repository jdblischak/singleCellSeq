...
Because we start with the [intersection of observed genes in the single cell or bulk samples][observed] and then the expression cutoff is based on the expresssion in the single cells, it is possible that a gene is not observed at all in the bulk samples.
