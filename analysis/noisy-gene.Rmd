...
#
cor(table_mean[,5:13],use="pairwise.complete.obs")
cor(table_var[,5:13],use="pairwise.complete.obs")
cor(table_cv[,5:13],use="pairwise.complete.obs")

heatmap(cor(table_mean[,5:13],use="pairwise.complete.obs"))
heatmap(cor(table_var[,5:13],use="pairwise.complete.obs"))
heatmap(cor(table_cv[,5:13],use="pairwise.complete.obs"))
