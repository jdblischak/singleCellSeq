...
ggplot(molecules_single_qc_expressed, aes(x = mean, y = CV))  + geom_point(size = 3, alpha = 0.5) + scale_x_log10()
...
# apply qc_filter
reads_single_filter <- reads_single[,summary_per_sample_reads_single_qc$qc_filter]
dim(reads_single_filter)
sum(summary_per_sample_reads_single_qc$qc_filter)
