...
## variance of gene expression between individuls using the bulk samples
...
## variance of 3 variances from 3 individaul
reads_var$variance.single19098<-variance.single19098
reads_var$variance.single19101<-variance.single19101
reads_var$variance.single19239<-variance.single19239

reads_var$var_of_var <- apply(reads_var[,c("variance.single19098","variance.single19098","variance.single19098")], 1, var, na.rm = TRUE)
...
ggplot(reads_var, aes(x = bulk_variance, y = mean_single_variance, shape = as.factor(ERCC), col = F_value)) + geom_point(size = 2, alpha = 0.5) + scale_x_log10() + scale_y_log10() + scale_colour_gradient2(midpoint= 1.5, limits=c(0,3),space="Lab") + stat_function(fun= function(x) {x}, col= "#56B4E9")

ggplot(reads_var, aes(x = bulk_variance, y = var_within_individual, shape = as.factor(ERCC), col = F_value)) + geom_point(size = 2, alpha = 0.5) + scale_x_log10() + scale_y_log10() + scale_colour_gradient2(midpoint= 1.5, limits=c(0,3),space="Lab") + stat_function(fun= function(x) {x}, col= "#56B4E9")

ggplot(reads_var, aes(x = bulk_variance, y = var_between_individual, shape = as.factor(ERCC), col = F_value)) + geom_point(size = 2, alpha = 0.5) + scale_x_log10() + scale_y_log10() + scale_colour_gradient2(midpoint= 1.5, limits=c(0,3),space="Lab") + stat_function(fun= function(x) {x}, col= "#56B4E9")

ggplot(reads_var, aes(x = var_all_single, y = var_within_individual, shape = as.factor(ERCC), col = F_value)) + geom_point(size = 2, alpha = 0.5) + scale_x_log10() + scale_y_log10() + scale_colour_gradient2(midpoint= 1.5, limits=c(0,3),space="Lab") + stat_function(fun= function(x) {x}, col= "#56B4E9")

ggplot(reads_var, aes(x = var_all_single, y = var_between_individual, shape = as.factor(ERCC), col = F_value)) + geom_point(size = 2, alpha = 0.5) + scale_x_log10() + scale_y_log10() + scale_colour_gradient2(midpoint= 1.5,limits=c(0,3), space="Lab") + stat_function(fun= function(x) {x}, col= "#56B4E9")
