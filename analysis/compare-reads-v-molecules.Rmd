...
reads_bulk_cpm <- read.table("../data/reads-bulk-cpm.txt", header = TRUE,
                    stringsAsFactors = FALSE)
...
total_counts_single <- ggplot(total_counts_data[total_counts_data$well != "bulk", ],
  ...
  geom_point(aes(col = as.factor(individual), shape = as.factor(replicate))) +
  geom_smooth(method = "lm") +
...
total_molecules_ind <- ggplot(total_counts_data,
...
total_counts_single_batch <- ggplot(total_counts_data,
                              aes(x = total_reads, y = total_molecules,
...
total_counts_single_ind <- ggplot(total_counts_data,
                              aes(x = total_reads, y = total_molecules)) +
