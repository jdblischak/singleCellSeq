...
>
> I have uploaded the data in fastq format to the Genomics Core ftp server data server (gilad Lab folder, folder = /gilad/NGS/150327_700819F_0304_AC6WURACXX-YG-SR100-FC-2). For access a username and password have been provided to the PI previously (not your CNET ID!!).

> Let me know if other files and / or explanations are needed.

> IMPORTANT: While the Core has looked at your data and found no technical Instead, you need to preface `/NGS` with `/Genomics_Data`.
