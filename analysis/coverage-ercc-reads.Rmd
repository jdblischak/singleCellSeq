---
title: "Coverage of ERCC spike-ins - single cell reads"
date: 2015-02-23
---
...
This is a companion to the analysis of the [read coverage of endogenous genes][endo].
...
**Using the single cell reads, we observe the same pattern as with the [molecules](coverage-ercc.html).**

[endo]: coverage-endogenous-reads.html
...
Using the same quality single cell samples from the analysis of the [read coverage of endogenous genes][endo].
...
This is the same pattern we observed using the [molecules](coverage-ercc.html).
See the [interpretation section](coverage-ercc.html#interpretation) in that file for potential explanations.
