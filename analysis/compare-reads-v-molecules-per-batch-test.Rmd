...
labs(x = "Batch", y = "Read-to-molecule conversion efficiency", title = "Batch effect of ENSG conversion efficiency") +
...
geom_boxplot(alpha = .01, width = .2, position = position_dodge(width = .9)) +
  scale_fill_manual(values = great_color) +
labs(x = "Batch", y = "Read-to-molecule conversion efficiency", title = "Batch effect of ERCC conversion efficiency") +
theme(axis.text.x = element_text(hjust=1, angle = 45))
...
```{r plot-reads-molecule-paper, fig.width=12, fig.height=6}
