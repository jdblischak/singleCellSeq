...
summary_per_sample_reads_single_qc$cut_off_mito <- summary_per_sample_reads_single_qc$mt_reads_ratio > cut_off_mito

## numbers of cells 
sum(summary_per_sample_reads_single_qc[summary_per_sample_reads_single_qc$cell_number == 1, "mt_reads_ratio"] > cut_off_mito)
