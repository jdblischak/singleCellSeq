...
plot_reads <- ggplot(summary_per_sample_reads_single_qc[summary_per_sample_reads_single_qc$cell_number == 0 |
       ...
       labs(x = "Total mapped reads", title = "Number of Total mappred reads")
```
...
data_lda$ERCC_conversion <- summary_per_sample_reads_single_qc$ERCC_conversion
...
### plots
```{r plots, fig.width=12, fig.heigh=6}
...
plot_grid(genes_unmapped + theme(legend.position = c(.75,.85)), 
          reads_unmapped_num + theme(legend.position = "none"), 
          reads_ercc_num + theme(legend.position = "none"),
          labels = LETTERS[3:5],
          nrow = 1)
...
plot_grid(ercc_reads_plot + theme(legend.position = "none"),
          ercc_molecule_plot + theme(legend.position = "none"),
          plot_reads + theme(legend.position=c(.7,.7)),
          plot_unmapped + theme(legend.position = "none"),
          plot_ercc + theme(legend.position = "none"), 
          plot_gene + theme(legend.position = "none"),
          labels = LETTERS[1:6],
...
theme_set(theme_bw(base_size = 12))
plot_grid(plot_before + theme(legend.position=c(.8,.8)), 
          plot_after + theme(legend.position = "none"),
          plot_ercc_before, 
          plot_ercc_after,
          labels = LETTERS[1:4])
