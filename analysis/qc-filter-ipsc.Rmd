...
```{r plots}
## for figure 1
reads_unmapped <-  ggplot(summary_per_sample_reads_single_qc,
...
reads_ercc <-  ggplot(summary_per_sample_reads_single_qc,
...
plot_grid(reads_unmapped + theme(legend.position = "none"), 
          reads_ercc + theme(legend.position = "none"),
          labels = LETTERS[1:2])
```
