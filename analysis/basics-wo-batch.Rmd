...
reads_filter <- read.table("../data/reads-filter.txt", header = TRUE,
                    stringsAsFactors = FALSE)
# Remove 19098.r2
reads_filter <- reads_filter[, grep("NA19098.r2", colnames(reads_filter),
                                    invert = TRUE)]
...
The results are similar per individual.
Batch NA19101.r3 has the most outliers, which are likely due to wells which actually contained more than one cell.
