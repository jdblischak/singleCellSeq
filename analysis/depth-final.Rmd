...
```{r sequencing-depth-num-cells, fig.width=12, fig.height=12}
...
```{r molecules-num-cells, fig.width=12, fig.height=12}
...
```{r perc-ercc-num-cells, fig.width=12, fig.height=12}
...
```{r molecules-num-cells-batch, fig.width=12, fig.height=20}
...
```{r ercc-metrics, fig.width=12, fig.height=8}
...
```{r ercc-metrics-high-quality, fig.width=12,  fig.height=8}
