...
is noise (currently I assume the same noise variance in each cell). For notational convenience let $\tilde{\beta}_c = [ \beta_c \mu_c ]$ and $\tilde{x}_{nc} = [ x_{nc} 1 ]$, then
...
This expected value is then used to linearly transformed the real gene cpm values, as before. 
