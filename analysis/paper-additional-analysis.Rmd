...
## Reads to molecule conversion efficiency in ERCC spike-ins
...
Concentration distribution is skewed for both ERCC and ENSG genes. Hence, we analyze the log2 concentration data (log2 base was taken so that our log transformation base is consistent throughout the paper).
