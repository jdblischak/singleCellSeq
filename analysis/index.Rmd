...
*  [Compare read versus molecule counts](compare-reads-v-molecules.html) - ([per batch](compare-reads-v-molecules-per-batch.html),[per batch conversion rates](compare-reads-v-molecules-per-batch-test.html), [per cell](compare-reads-v-molecules-in-cells.html)) 
...
*  [Proportion of detected genes](pca-correlation-rafa.html) - ([filter and final](pca-correltation-rafa-filter.html))
...
*  Explore individual differences in coefficient of variation
     * [Normalize CV](cv-adjusted.html)([Without NA19098.r2](cv-adjusted-wo-19098-r2.html))
     * [CV and sparsity](cv-sparsity-html)
     * Transcriptome-wide comparison of CV between individuals
     * Per-gene analysis of individual differences in CV
          * [Statistical test](cv-adjusted-all-genes.html)([Without NA19098.r2](cv-adjusted-all-genes-wo-19098-2.html))
          * [Overlap with cell-cycle genes and pluripotent genes](cv-adjusted-explore.html)([Without NA19098.r2](cv-adjusted-explore-wo-19098-r2.html))
          * [Individual difference in mean versus in CV](cv-mean.html)
