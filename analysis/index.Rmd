...
*  Batch effect correction with mixed modeling
     * [limma - Cross design](batch-limma.html)
...
*  Explore individual differences in coefficient of variation
     * iPSC with normalized CV([testings](cv-adjusted.html), [gene annotations](cv-adjusted-explore.html), [mean or CV?](cv-mean.html))
     * [CV and sparsity](cv-sparsity.html)
     * [Small-sample parametric test of variance equality](compare-variances.html)
     * [Small-sample non-parametric ANOVA](cv-explore-distribution.html)
