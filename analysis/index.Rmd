...
*  Individual differences in coefficient of variation
     ...
     * Statistical significance individual differences 
          * [ANOVA](cv-adjusted-all-genes-wo-19098-2.html) - [Annotations](cv-adjusted-explore-wo-19098-2.html) ( [Include NA19098.r2](cv-adjusted-all-genes.html) - [Annotations](cv-adjusted-explore.html), [Annotate genes with mean/CV differences](cv-annotation.html), [Subsampling](cv-subsampling.html) )
          * [Sum-of-Squared-Deviation-From-the-Median](cv-adjusted-statistical-test.html) ( [Bootstrapped CIs](cv-adjusted-statistical-test-bootstrap.html), [Permutation-based p-values](cv-adjusted-statistical-test-permute.html) )
