...
*  [Proportion of detected genes](pca-correlation-rafa.html) - ([filter and final](pca-correlation-rafa-filter.html))
     ...
     *  [More exploring of the proportion of genes detected](prop-genes-detected.html)
...
*  Biological variation analysis
     ...
     * Exploratory analysis
          ...
          * Small-sample significance test - ( [parametric test](compare-variances.html), [non-parametric test](cv-explore-distribution.html) )
     ...
     * Mean-adjusted CV - ( [Normalize CV, excluding outlier batch](cv-adjusted-wo-19098-r2.html), [Normalize CV, including NA19098.r2](cv-adjusted.html), [Gene rankings](cv-adjusted-profile.html), [Gene rankings & annotations](cv-adjusted-profile-annotation.html), [Per gene dissimilarity measure](cv-adjusted-comparison.html) )
     ...
     * [Putting it all together...] -- ([final and Gaussian-based transformation](cv-adjusted-summary.html), [final and Poisson-based transformation](cv-adjusted-summary-pois.html), [Pluripotent gene density plots](compare-distribution-pluripotency.html) )
