...
*  [Batch effect correction with mixed modeling](batch-limma.html) - ([filter and final](batch-limma-final.html))
...
*  Individual differences in coefficient of variation
     ...
     * Profile cell-to-cell heterogeneity
          * [Individual adjusted CV and mean](cv-adjusted-profile.html) - ([Annotations](cv-adjusted-profile-annotation.html))
          * [Gene-level similarity between adjusted CV](cv-adjusted-comparison.html)
          * [Statistical significance](cv-adjusted-statistical-test.html)
               *[Bootstrapped CIs](cv-adjusted-statistical-test-bootstrap.html)
               *[Permutation-based p-values](cv-adjusted-statistical-test-permute.html)
          * [Putting all together...](cv-adjusted-profile-per-gene.html)
