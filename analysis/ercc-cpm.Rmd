...
[linear shift normalization](ercc-normalization.html#linear-shift-normalization).
...
plot_pca(pca_single_norm$PCs, explained = pca_single_norm$explained,
         metadata = anno_single, color = "individual",
         shape = "batch", factors = c("individual", "batch")) + labs(title = "Linear shift normalization")
```
