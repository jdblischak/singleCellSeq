...
## cpm transformation based on total molecule counts
...
## cpm transformation based on ERCC reads
```{r ercc-cpm-reads}
## read counts and molecule counts of ERCC
reads_single_ERCC <- reads_single[grep("ERCC", rownames(reads_single)), ]

## sum of ERCC readds per cell
molecules_single_ERCC <- rbind(molecules_single_ERCC, apply (reads_single_ERCC, 2, sum))

## cpm of total ERCC reads per cell
