...
## The effect of pseudocount 

```{r pseudocount, fig.width=12, fig.height=12}
molecules_single_pca_0.25 <- run_pca( cpm( molecules_single) )
molecules_single_pca_0.26 <- run_pca( cpm( molecules_single + 0.01) )
molecules_single_pca_0.75 <- run_pca( cpm( molecules_single + 0.5) )
molecules_single_pca_1.25 <- run_pca( cpm( molecules_single + 1) )

pc1_0.25 <- qplot(y = molecules_single_pca_0.25$PCs[,1],
      x = molecules_prop_genes_detected$prop,
      shape = as.factor(anno_filter$replicate),
      colour = as.factor(anno_filter$individual),
      xlab = "Proportion of genes detected",
      ylab = "PC1 Pseudocount (0.25)")

pc1_0.26 <- qplot(y = molecules_single_pca_0.26$PCs[,1],
      x = molecules_prop_genes_detected$prop,
      shape = as.factor(anno_filter$replicate),
      colour = as.factor(anno_filter$individual),
      xlab = "Proportion of genes detected",
      ylab = "PC1 Pseudocount (0.26)")

pc1_0.75 <- qplot(y = molecules_single_pca_0.75$PCs[,1],
      x = molecules_prop_genes_detected$prop,
      shape = as.factor(anno_filter$replicate),
      colour = as.factor(anno_filter$individual),
      xlab = "Proportion of genes detected",
      ylab = "PC1 Pseudocount (0.75)")

pc1_1.25 <- qplot(y = molecules_single_pca_1.25$PCs[,1],
      x = molecules_prop_genes_detected$prop,
      shape = as.factor(anno_filter$replicate),
      colour = as.factor(anno_filter$individual),
      xlab = "Proportion of genes detected",
      ylab = "PC1 Pseudocount (1.25)")

plot_grid(pc1_0.25 + theme(legend.position = "none"),
          pc1_0.26 + theme(legend.position = "none"),
          pc1_0.75 + theme(legend.position = "none"),
          pc1_1.25 + theme(legend.position = "none"),
          nrow = 2,
          labels = LETTERS[1:4])
```
