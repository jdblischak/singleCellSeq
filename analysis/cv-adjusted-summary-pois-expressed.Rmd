...
print(colnames(fit_w)[1])
sum(p.adjust(fit_w$p.value[,1], method = "fdr") < .01 & abs(log2fc$NA19098_NA19101) > 2, na.rm = TRUE)
gene_elect <- rownames(fit_w)[which(p.adjust(fit_w$p.value[,1], method = "fdr") < .01 & abs(log2fc$NA19098_NA19101) > 2)]
...
```{r, fig.width=7, fig.height=10}
print(colnames(fit_w)[2])
sum(p.adjust(fit_w$p.value[,2], method = "fdr") < .01 & abs(log2fc$NA19098_NA19239) > 2, na.rm = TRUE)

gene_elect <- rownames(fit_w)[which(p.adjust(fit_w$p.value[,2], method = "fdr") < .01 & abs(log2fc$NA19098_NA19239) > 2)]
...
title(main = "NA19098_NA19239", outer = TRUE, line = -1)
...
```{r, fig.width=7, fig.height=3.5}
print(colnames(fit_w)[3])
sum(p.adjust(fit_w$p.value[,3], method = "fdr") < .01 & abs(log2fc$NA19101_NA19239) > 2, na.rm = TRUE)

gene_elect <- rownames(fit_w)[which(p.adjust(fit_w$p.value[,3], method = "fdr") < .01 & abs(log2fc$NA19101_NA19239) > 2)]
