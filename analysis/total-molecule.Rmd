...
## The total molecule-counts (not including NA19098)

For wells with a single cell observed, the total molecule-counts range from
`r format(min(anno_single$total_molecules_gene[anno_single$cell_number == 1 & anno_single$individual != "NA19098"]))`
to
`r format(max(anno_single$total_molecules_gene[anno_single$cell_number == 1 & anno_single$individual != "NA19098"]))`,
