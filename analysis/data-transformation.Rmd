...
plot_pca(pca_reads_filter$PCs, explained = pca_reads_filter$explained,
...
plot_pca(pca_molecules_filter$PCs, explained = pca_molecules_filter$explained,
         metadata = anno_filter, color = "individual",
         shape = "batch", factors = c("individual", "batch")) +
...
plot_pca(pca_reads_bulk_filter$PCs, explained = pca_reads_bulk_filter$explained,
...
plot_pca(pca_molecules_collision$PCs, explained = pca_molecules_collision$explained,
         metadata = anno_filter, color = "individual",
         shape = "batch", factors = c("individual", "batch")) +
...
plot_pca(pca_reads_bulk_cpm$PCs, explained = pca_reads_bulk_cpm$explained,
         metadata = anno[anno$well == "bulk", ], color = "individual",
         shape = "batch", factors = c("individual", "batch")) +
...
plot_pca(pca_molecules_cpm$PCs, explained = pca_molecules_cpm$explained,
         metadata = anno_filter, color = "individual",
         shape = "batch", factors = c("individual", "batch")) +
...
boxplot(intercept ~ anno_filter$individual + anno_filter$batch,
        xlab = "Batch", ylab = "Intercept",
        main = "Variation in intercept from linear transformation")
```

```{r linear-transformation-slope}
boxplot(slope ~ anno_filter$individual + anno_filter$batch,
        xlab = "Batch", ylab = "Slope",
...
plot_pca(pca_molecules_cpm_trans$PCs, explained = pca_molecules_cpm_trans$explained,
         metadata = anno_filter, color = "individual",
         shape = "batch", factors = c("individual", "batch")) +
...
```{r unique-batch}
batch_unique <- with(anno_filter, paste(individual, "_", batch, sep = "") )
table(batch_unique)
```
...
```{r design-matrix}
block <- batch_unique
design <- model.matrix(~ 1 + as.factor(individual), data = anno_filter)
```
...
plot_pca(pca_final$PCs, explained = pca_final$explained,
         metadata = anno_filter, color = "individual",
         shape = "batch", factors = c("individual", "batch")) +
