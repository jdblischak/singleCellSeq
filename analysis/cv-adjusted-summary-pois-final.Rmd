...
![Bio-figure1](../analysis/figure/cv-adjusted-summary-pois-final.Rmd/bio-figure1.png) 
...
![Bio-figure2](../analysis/figure/cv-adjusted-summary-pois-final.Rmd/bio-figure2.png) 
...
for (i in 1:nrow(pluri_results)) {
    ...
    for (which_individual in unique(anno_filter$individual)) {
        plot_density_overlay(
             ...
             individual_label = anno_filter$individual,
...
plot_grid(
  ggplot( data.frame(pvals = permuted_pval_all$mad_pval),
         aes(x = pvals) ) +
    geom_histogram() + xlim(0, 1) +
    labs(x = "Permutation-based p-values", y = "Count"),
