...
To answer the question if OE genes are more highly expressed, the average molecule cmp of OE genes or of all genes in each cells were plotted. If the OE genes are highly expressed, it is possible that this position effect is present in all genes but can only be observed with certain amount of expressing level.
