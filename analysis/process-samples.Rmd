...
[rmdup-umi.sh][] counts the number of UMIs at each start position using `umitools rmdup` ([v2.1.1][umitools]).
To account for errors introduced during PCR amplification and sequencing, UMIs within an edit distance of 1 are merged into a single UMI (flag `--mismatches 1`).
