...
As expected, all genes with at least one observed molecule also had at least one observed read in the single cell samples.
...
genes_observed <- intersect(genes_observed_reads, genes_observed_reads_bulk)
