...
# write.table(rownames(molecules_ENSG[sig_cv, ]), file = 
# "~/Dropbox/temp.txt", row.names = FALSE, col.names = FALSE)
```
...
![This is the confidence view](figure/cv-mean.Rmd/string1.png)
This is the evidence view. Different line colors represent the types of evidence for the association.
![This is the evidence view](figure/cv-mean.Rmd/string2.png)
