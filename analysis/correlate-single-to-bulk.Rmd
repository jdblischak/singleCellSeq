  ...
  do
    ...
    do
      ...
      do
        ...
        CMD="correlate-single-to-bulk.R $CELLS $SEED counts-matrix/$NUM-molecules-raw-single-per-sample.txt $ssc/data/reads-raw-bulk-per-sample.txt --individual=$IND --good_cells=/mnt/lustre/home/jdblischak/singleCellSeq/data/quality-single-cells.txt"
        ...
        CMD="correlate-single-to-bulk.R $CELLS $SEED counts-matrix/$NUM-molecules-raw-single-per-sample.txt $ssc/data/reads-raw-bulk-per-sample.txt --individual=$IND --good_cells=/mnt/lustre/home/jdblischak/singleCellSeq/data/quality-single-cells.txt -q .5"
